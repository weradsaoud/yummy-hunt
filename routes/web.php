...
//Route::get('/', function() {echo phpinfo();})->name('front');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('manageAppHeader', 'SettingsController@manageAppHeader')->name('settings.manage_app_header');
    Route::post('add-header-text-r', 'SettingsController@addHeaderTextR')->name('settings.add_header_text_r');
    Route::post('add-header-text-s', 'SettingsController@addHeaderTextS')->name('settings.add_header_text_s');
    ...
    Route::get('/apply-discount', 'RestorantController@applyDiscount')->name('apply-discount');
...
Route::post('/tablebook', 'OrderController@tablebook')->name('table.book');
