<div id="cartSideNav" class="sidenav-cart sidenav-cart-close">
    <div class="offcanvas-menu-inner">
        ...
        <div class="minicart-content">
                        ...
                        <div class="info-block block-info clearfix" v-cloak>
                            ...
                            <div class="row">
                                ...
                                <button type="button" v-on:click="remove(item.id)"  :value="item.id" class="btn btn-outline-primary btn-icon btn-sm page-link btn-cart-radius">
                                    <span class="btn-inner--icon btn-cart-icon" id="trash_id"><i class="fa fa-trash"></i></span>
                                    <span class="spinner-border spinner-border-sm d-none" role="status" aria-hidden="true" id="trash_loader"></span>
                                </button>
                            </div>
                        </div>
                    </div>
                </div>
                <dißv id="totalPrices" v-cloak>
                    <div  class="card card-stats mb-4 mb-xl-0">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <span id="cart_empty"  v-if="totalPrice==0"><?php echo e(__('Cart is empty')); ?>!</span>
            ...
            <span class="spinner-border d-none" style="position:absolute;left:50%;top:50%;z-index:22"  role="status" aria-hidden="false" id="loader_on_open"></span>
            </div>
        </div>
    </div>
</div>
<?php /**PATH /home/laravel/web/syr.yummy-hunt.com/public_html/resources/views/layouts/navbars/cartSideMenu.blade.php ENDPATH**/ ?>