...
<?php echo $__env->make('restorants.partials.modals', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <section class="section section-lg d-md-block d-lg-none d-lx-none" style="padding-bottom: 0px">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="title">
                        <h1 class="display-3 text"  style="cursor: pointer;"><?php echo e($restorant->name); ?></h1>
    ...
    <section class="section pt-lg-0" id="restaurant-content" style="padding-top: 0px">
        ...
        <div class="container container-restorant">
            ...
            <!--            <a href="#" class="nav-link  mb-sm-3 mb-md-0 active bg-success" id="open-book" ><?php echo e(__('Book Table')); ?></a>-->
            <!--        </li>-->
            <!--   </ul>-->
        ...
        <nav class="tabbable sticky" style="top: <?php echo e(config('app.isqrsaas') ? 64:88); ?>px;">
                <ul class="nav nav-pills bg-white mb-2">
                    <li class="nav-item nav-item-category " id="table-booking">
                        <a href="#" class="nav-link  mb-sm-3 mb-md-0 active bg-success" data-toggle="tab" role="tab" id="<?php echo e('nav_'.clean('table-booking')); ?>" href="#table-booking"><?php echo e(__('Book Table')); ?></a>
                    </li>
                    <li class="nav-item nav-item-category ">
                    ...
                    <?php $__currentLoopData = $category->aitems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                            <div class="strip">
                                ...
                                <span class="res_mimimum"><?php if($item->original_price && @$item->discount_percent): ?><strike><?php echo money($item->original_price, config('settings.cashier_currency'),config('settings.do_convertion')); ?></strike><?php endif; ?>  <?php echo money($item->price, config('settings.cashier_currency'),config('settings.do_convertion')); ?></span>
                                <?php if($item->original_price && @$item->discount_percent): ?>
                                <div class="discount-tag">
                                    <?php echo e(@$item->discount_percent); ?> % OFF
                                </div>
                                
                                <?php endif; ?>
                                 <div class="discount-tag-bottom">
                                    <?php echo e($category->id); ?>-<?php echo e(@$loop->index); ?> 
                                </div>
                            </div>
            ...
            <?php endif; ?>
             <div id="table-booking" class="<?php echo e(clean('table-booking')); ?>">
                    <h1>Book Table</h1><br />
                </div>
             <div class="row table-booking">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <form method="post" action="<?php echo e(route('table.book')); ?>">
                            <?php echo csrf_field(); ?>
                             <input type="hidden" name="res_id" value="<?php echo e($restorant->id); ?>"/>
                          <!--<div class="form-group">-->
                          <!--      <label class="form-control-label" for="driver"><?php echo e(__('Select Restaurant Area')); ?></label>-->
                          <!--      <select class="form-control select2" name="area">-->
                          <!--          <option  selected value> -- <?php echo e(__('Select an option')); ?> -- </option>-->
                          <!--          <?php if(!$restorant->areas->isEmpty()): ?>-->
                          <!--              <?php $__currentLoopData = $restorant->areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>-->
                          <!--              <option   value> <?php echo e($area->name); ?> </option>-->
                          <!--              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>-->
                          <!--          <?php endif; ?>-->
                          ...
                          <!--  </div>-->
                             ...
                             <div class="form-group col-md-8" id="">
                                <label class="form-control-label" for="driver"><?php echo e(__('Select Table')); ?></label>
                                <select class="form-control select2" name="table">
                                    <option  selected value> -- <?php echo e(__('Select an option')); ?> -- </option>
                                     <?php if(!$restorant->tables->isEmpty()): ?>
                                        ...
                                        <option   value="<?php echo e($table->id); ?>"><b> <?php echo e($table->name); ?></b> (Size:<?php echo e($table->size); ?> | Area: <?php echo e($table->restoarea->name); ?>)  </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
                             ...
                             <div class="form-group col-md-6" id="">
                                  <label class="form-control-label" for="driver"><?php echo e(__('Comment')); ?></label>
                          ...
                          <button type="submit" class="btn btn-primary ml-3">Book</button>
                        </form>
                    </div>
                </div>
        </div>
...
//   var x = document.getElementById("book-table");
...
<script>
    ...
    */
    ...
    function setCurrentItem(id){
        ...
        previouslySelected=[];
        console.log(item)
          if(item.original_price && item.discount_percent){
        $("#discount-tag").show();
        $("#discount-tag").html(item.discount_percent+"% OFF");
...
<?php echo $__env->make('layouts.front', ['class' => ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/9a/f/f4e2e25701/public_html/resources/views/restorants/show.blade.php ENDPATH**/ ?>