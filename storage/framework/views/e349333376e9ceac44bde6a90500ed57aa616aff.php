                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group<?php echo e($errors->has('item_price') ? ' has-danger' : ''); ?>">
                                            ...
                                            <input type="number" step="any" name="item_price" id="item_price" class="form-control form-control-alternative<?php echo e($errors->has('item_price') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Price')); ?>" value="<?php echo e(old('item_price', $item->original_price)); ?>" required autofocus>
...
<?php echo $__env->make('layouts.app', ['title' => __('Orders')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/laravel/web/ae.yummy-hunt.com/public_html/resources/views/items/edit.blade.php ENDPATH**/ ?>