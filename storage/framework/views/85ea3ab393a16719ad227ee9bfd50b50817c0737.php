                                            ...
                                            <a href="<?php echo e(route('items.edit', $item)); ?>">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <span class="badge badge-primary badge-pill"><?php echo money($item->original_price, config('settings.cashier_currency'),config('settings.do_convertion')); ?></span>
...
<?php echo $__env->make('layouts.app', ['title' => __('Restaurant Menu Management')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/laravel/web/ae.yummy-hunt.com/public_html/resources/views/items/index.blade.php ENDPATH**/ ?>