...
<script>
    ...
    $.getJSON("https://ae.dealont.com/index.php/wp-json/listar/v1/place/list?s=<?php echo e(auth()->user()->restorant['name']); ?>", function(result){
    ...
    //http://ae.dealont.com/index.php/wp-json/listar/v1/place/list?s=Restaurant 3
        ...
        $("#submit-btn").hide();
         $("#loading").show();
        $.getJSON("https://ae.yummy-hunt.com/api/v2/client/items/<?php echo e(auth()->user()->restorant['id']); ?>", function(result){
       console.log(result.data)
       $("#submit-btn").show();
         $("#loading").hide();
         $("#items").empty();
   ...
   $('input[type=radio]').click(function(){
    ...
    function bulk(rest_id,diss) {
         ...
         console.log(item_id,diss,api_key,"99y98j");
          $("#submit-btn").hide();
         $("#loading").show();
         console.log(`https://ae.yummy-hunt.com/api/v2/client/discount-all/<?php echo e(auth()->user()->restorant['id']); ?>/${diss}?api_key=${api_key}`)

        $.getJSON(`https://ae.yummy-hunt.com/api/v2/client/discount-all/<?php echo e(auth()->user()->restorant['id']); ?>/${diss}?api_key=${api_key}`, function(result){
      console.log(result)
      listarSave();
    });
    }
...
<?php echo $__env->make('layouts.app', ['title' => __('Share Menu')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/laravel/web/ae.yummy-hunt.com/public_html/resources/views/restorants/applydiscount.blade.php ENDPATH**/ ?>