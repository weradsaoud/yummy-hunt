<ul class="navbar-nav">
    ...
    <?php endif; ?>
        ...
        <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('settings.manage_app_header')); ?>">
                <i class="ni ni-settings text-black"></i> <?php echo e(__('Manage App Header ')); ?>
...
<?php /**PATH /home/laravel/web/syr.yummy-hunt.com/public_html/resources/views/layouts/navbars/menus/admin.blade.php ENDPATH**/ ?>