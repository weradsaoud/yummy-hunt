                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $restorants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $restorant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                         <!--<td><input type='checkbox' name='deletes[]' value='<?php echo e($restorant->id); ?>' ></td>-->
...
<?php echo $__env->make('layouts.app', ['title' => __('Restaurants')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/laravel/web/syr.yummy-hunt.com/public_html/resources/views/restorants/index.blade.php ENDPATH**/ ?>