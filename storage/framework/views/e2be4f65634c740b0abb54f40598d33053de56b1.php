<section class="section-hero-shape" data-offset-top="#header-main" style="padding-top: 147.188px;">
            ...
            <div class="col-lg-5 col-xl-6 text-center text-lg-left">
              ...
              <div>
                <h2 class="text-white mb-4">
                  <div class="display-4 font-weight-light ckedit"><?php echo e(__('whatsapp.hero_title')); ?></div>
                  <div class="d-block ckedit"><?php echo e(__('whatsapp.hero_subtitle')); ?></div>
                </h2>
                <p class="lead text-white ckedit"><?php echo e(__('whatsapp.hero_description')); ?></p>
                <div class="mt-5">

                  <?php if(auth()->user()&&auth()->user()->hasRole('admin')): ?>
                  <div class="ckedit btn btn-icon btn-white rounded-pill" key="start_now"><?php echo e(__('whatsapp.start_now')); ?></div>
                  <div class="btn btn-icon rounded-pill btn-outline-white" key="see_demo"><?php echo e(__('whatsapp.see_demo')); ?></div>
                  <?php else: ?>
    ...
    </section><?php /**PATH /home/sites/9a/f/f4e2e25701/public_html/resources/views/social/partials/hero.blade.php ENDPATH**/ ?>