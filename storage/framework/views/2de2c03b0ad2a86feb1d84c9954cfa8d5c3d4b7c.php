<ul class="navbar-nav">
    ...
    <li class="nav-item">
     ...
     <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('apply-discount')); ?>">
                <i class="ni ni-percent text-green"></i> <?php echo e(__('Apply Discount')); ?>

            </a>
    </li>

</ul>
<?php /**PATH /home/laravel/web/ae.yummy-hunt.com/public_html/resources/views/layouts/navbars/menus/owner.blade.php ENDPATH**/ ?>