        ...
        <nav class="tabbable sticky" style="top: <?php echo e(config('app.isqrsaas') ? 64:88); ?>px;">
                <ul class="nav nav-pills bg-white mb-2">
                    <li class="nav-item nav-item-category " id="table-booking">
                        <a href="#" class="nav-link  mb-sm-3 mb-md-0 bg-success" data-toggle="tab" role="tab" id="<?php echo e('nav_'.clean('table-booking')); ?>" href="#table-booking"><?php echo e(__('Book Table')); ?></a>
                    </li>
                    <li class="nav-item nav-item-category ">
            ...
            <?php endif; ?>
             <div id="table-booking" class="<?php echo e(clean('table-booking')); ?>">
                    <h1><?php echo e(__('Book Table')); ?></h1><br />
                </div>
             <div class="row table-booking">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <form method="post" action="<?php echo e(route('table.book')); ?>">
                          ...
                          <button type="submit" class="btn btn-primary ml-3"><?php echo e(__('Book')); ?></button>
                        </form>
                    </div>
                </div>
        </div>
    ...
    <?php $__env->startSection('addiitional_button_1'); ?>
        <div class="dropdown web-menu" >
            ...
            <ul class="dropdown-menu" aria-labelledby="">
                <?php $__currentLoopData = $restorant->localmenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.front', ['class' => ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/laravel/web/syr.yummy-hunt.com/public_html/resources/views/restorants/show.blade.php ENDPATH**/ ?>