                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group{{ $errors->has('item_price') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="number" step="any" name="item_price" id="item_price" class="form-control form-control-alternative{{ $errors->has('item_price') ? ' is-invalid' : '' }}" placeholder="{{ __('Price') }}" value="{{ old('item_price', $item->original_price) }}" required autofocus>
