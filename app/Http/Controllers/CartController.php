...
class CartController extends Controller
{
    ...
    {
        $item = Items::with('category.restorant')->find($request->id);
    ...
    public function cart()
    {
        ...
        if(!$isEmpty){
            ...
            //The restaurant
            $restaurant = Restorant::with('hours')->findOrFail($restorantID);
            ...
            $tables = Tables::with('restoarea')->where('restaurant_id', $restaurant->id)->get();
            $tablesData = [];
