...
class RestorantController extends Controller
{
    ...
    public function showRegisterRestaurant(Request $request)
    {
        if(@$request->lang === "en"){
         App::setLocale("en");
        ...
        return view('restorants.register',[ 'currentLanguage'=>$currentEnvLanguage]);
    }
    ...
    public function storeRegisterRestaurant(Request $request)
    {
        ...
        //Recaptcha Verify
        $secretKey = "6Lf61aYcAAAAABjRcBT9unkaH9b8fBQ4MVtzvXH1";
         $url = 'https://www.google.com/recaptcha/api/siteverify';
         $data = array('secret' => $secretKey, 'response' => $request->g_recaptcha_response);
        ...
        throw ValidationException::withMessages(['RecaptchError' => 'Please verify you are not robot , Try Again']);
          }
    }
     ...
     public function applyDiscount()
    {
        ...
        return view('restorants.applydiscount', ['url' => $url, 'name'=>auth()->user()->restorant->name]);
    }
