...
class Items extends TranslateAwareModel
{
    ...
    protected $fillable = ['name', 'description', 'image', 'price', 'original_price', 'category_id', 'vat'];
    ...
    public function getItemoriginalpriceAttribute()
    {
        return  Money($this->original_price, config('settings.cashier_currency'), config('settings.do_convertion'))->format();
    }
